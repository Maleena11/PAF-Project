...
-- Bookings
INSERT INTO bookings (id, resource_id, user_id, title, start_time, end_time, status, notes, created_at)
VALUES
  (1, 1, 2, 'PAF Lecture',          '2026-03-15 09:00:00', '2026-03-15 11:00:00', 'APPROVED',  'Weekly PAF module lecture',         CURRENT_TIMESTAMP),
  (2, 2, 3, 'Web Dev Workshop',     '2026-03-16 14:00:00', '2026-03-16 17:00:00', 'PENDING',   'React & Spring Boot workshop',      CURRENT_TIMESTAMP),
  (3, 3, 4, 'Group Project Meeting','2026-03-17 10:00:00', '2026-03-17 12:00:00', 'APPROVED',  'Smart Campus project discussion',   CURRENT_TIMESTAMP),
  (4, 1, 2, 'Guest Lecture',        '2026-03-18 09:00:00', '2026-03-18 10:00:00', 'CANCELLED', 'Speaker cancelled',                 CURRENT_TIMESTAMP);
